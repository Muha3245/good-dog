...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Create New Question</h1>
            </div>
            @if(session('success'))
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('type') is-invalid @enderror" 
                                    ...
                                    <option value="description" {{ old('type', $question->type ?? '') == 'description' ? 'selected' : '' }}>Description</option>                                    <option value="radio" {{ old('type') == 'radio' ? 'selected' : '' }}>Radio Buttons</option>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function toggleOptions() {
            ...
            if (needsOptions) {
                ...
                document.querySelectorAll('#options-wrapper input').forEach(input => {
                    input.required = true;
                });
            }
        }
